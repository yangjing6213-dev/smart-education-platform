...
本仓库用于“学生托管机构智能化系统平台”的多租户 SaaS 规划、原型与早期基础实现。Phase 1A Batch A、Batch B 均为 `HISTORICAL/FROZEN`；Phase 1B Task 01—09 已接受并冻结，Task 10 Stage A 已通过负责人审阅但 Stage B 未授权，Task 11 未启动，Task 12 Stage B 已完成并通过负责人审阅，Task 12 Stage C1 已授权，Task 13+ 未启动且未授权。

当前活动治理以 `docs/project/PHASE_1B_GOVERNANCE_AND_API_FRAMEWORK_AUTHORITY_V19.md` 为准（SHA-256：`9A6C417329E8A95372DBC39D1EF1F83F1A634E10C456FCA9F9C01AF6D6DA7D19`）。Task 12 当前只获授权生成 Stage C1 review、detached manifest 和 deterministic ZIP；C2 及 Task 13+ 未授权。任何新阶段仍须独立负责人授权；不得从 Stage B 审阅或 C1 证据自动推导 C2 acceptance。
...
Batch B 固定交付为 47 个 A 级页面、12 个 B 级流程、59 个浏览器路由、15 张真实浏览器截图、V0.1 技术基线、18 个独立 TDD 任务的 Phase 1B 计划、自动验证器及 86 项精确白名单审查包。上述 Batch B 合同与证据保持历史冻结。当前 Phase 1B 活动治理以 `docs/project/PHASE_1B_GOVERNANCE_AND_API_FRAMEWORK_AUTHORITY_V19.md` 为准（SHA-256：`9A6C417329E8A95372DBC39D1EF1F83F1A634E10C456FCA9F9C01AF6D6DA7D19`）：Task 01—09 已接受并冻结；Task 10 Stage A 已通过负责人审阅但 Stage B 未授权；Task 11 未启动；Task 12 Stage B commit `e0cefee6417835ee7af24f572dfa76c82a5c3e63` 已通过负责人审阅，Stage C1 已授权但尚未形成最终证据；Task 12 C2 与 Task 13+ 未授权。本文件及其他冻结文件中的旧阶段语句仅属 `HISTORICAL/FROZEN` 记录；当前 API 为 Fastify 5.12.1，runtime 为 Node 24.14.0 与 pnpm 11.22.0，T12 为 `T02 -> T03 -> T05`，T10 为 `T05 -> T08 -> T12`。
