...
当前活动治理以 `docs/project/PHASE_1B_GOVERNANCE_AND_API_FRAMEWORK_AUTHORITY_V9.md` 为准（SHA-256：`B4E53F632AC135925CBAE802CE360D361EE2394044C339137F11A9B045A96165`）。Task 01—06 已由负责人验收并冻结；Task 07 Stage A 已通过负责人审阅，Stage B 获得独立负责人授权并正在修复和实施；Task 07 C1/C2 与 Task 08+ 仍未授权。任何新任务仍须独立合同、稳定 SHA、项目负责人批准和单独实现授权；不得从已完成任务或 Stage A 自动推导后续实现授权。
