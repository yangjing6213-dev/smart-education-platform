...
local evidence gates and are ready for owner review. The V32 authority records
...
accepted and frozen under the active V32 authority.
...
Stop immediately with `STATUS=BLOCKED` if the V32 baseline, branch, HEAD,
