...
V27 active-lifecycle overlay. The Stage A and Stage B sections below remain the
...
V27 is the current active governance authority. Task 01—12 are accepted and
frozen. Task 12's separately authorized minimal route repair is implemented,
verified, owner-reviewed, and frozen. Task 13 Stage A passed owner review and
Stage B is authorized but not started; Task 13 C1/C2 and Task 14+ remain
unauthorized.
