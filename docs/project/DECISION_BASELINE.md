...
当前 Phase 1B Task 01—04 的活动治理以
`docs/project/PHASE_1B_GOVERNANCE_AND_API_FRAMEWORK_AUTHORITY_V2.md`
为准（SHA-256：`5C9FA63960F47AC3986C18D36069D395086A2E7C4FD23A56412D5232589299AA`）。
authority 使用全文件、无自引用 SHA 约定；当前文件状态为未提交，最终独立验收仍待完成。
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`：原子范围精确为 authority、`AGENTS.md`、`PLANS.md`、`README.md`、本文件、`docs/project/SCOPE_AND_NON_SCOPE.md` 及两个 Phase 1B 活动计划文件。Task 01—04 合同、任务实例、模板、验证器与 Batch A/Batch B 固定证据继续冻结，不属于待改写的当前活动引用。
