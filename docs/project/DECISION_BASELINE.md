...
authority 使用全文件、无自引用 SHA 约定；Task 05 Stage B、C1、C2 已完成并冻结，Task 06 尚未启动。
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`：原子范围精确为 V4 authority、`AGENTS.md`、`PLANS.md`、`README.md`、本文件、`docs/project/SCOPE_AND_NON_SCOPE.md`、两个 Phase 1B 活动计划文件和 Task 05 合同/计划。Task 05 C2 acceptance、C1 review、manifest、ZIP、Task 01—04 合同与冻结证据均保持原样；`scripts/verify_task_05.mjs` 保留为 C2 前历史 verifier，不作为 C2 后 acceptance gate 重跑。
