...
为准（SHA-256：`DFFD3D38999AA7BB00304032F2C6322432AFDBD16B08CF5B3D7555E26C15C323`）。authority 使用全文件、无自引用 SHA 约定；
...
minimal entrypoint repair 已完成，API/admin-web 入口已接线并通过本地验证，六类审计动作已完成本地验证，当前等待负责人验收；C1/C2 尚未授权；Task 18+ 尚未启动且未获授权。
