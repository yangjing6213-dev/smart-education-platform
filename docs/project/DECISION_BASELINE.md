...
当前 Phase 1B Task 01—06 与 Task 07 Stage B implementation 的活动治理以
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`：原子范围精确为 V8 authority、七个活动治理引用文件和 Task 07 合同与计划。V7 及更早 authority、Task 06 C2 acceptance、Task 01—06 合同与冻结证据均保持原样；Task 06 C1 review、manifest、ZIP 保持为 C1 历史冻结快照，不在本轮重生成范围内。
