...
当前 Phase 1B Task 01—08 的活动治理以
`docs/project/PHASE_1B_GOVERNANCE_AND_API_FRAMEWORK_AUTHORITY_V14.md`
为准（SHA-256：`34323408892CC933F96DF1EA95F92F7A4F64D530B1851A24608BD78CE872B339`）。
authority 使用全文件、无自引用 SHA 约定；Task 01—08 已完成并冻结，Task 08 C2 为 acceptance-record-only 验收记录。
