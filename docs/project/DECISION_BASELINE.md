...
为准（SHA-256：`0B7EDB113CBD6D3DA02B535176E63ED53AEA1571C7047D1ADDE605811508A4E5`）。
authority 使用全文件、无自引用 SHA 约定；Task 05 Stage B 已完成，C1 证据已形成，当前等待负责人审阅。
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`：原子范围精确为 V3 authority、`AGENTS.md`、`PLANS.md`、`README.md`、本文件、`docs/project/SCOPE_AND_NON_SCOPE.md`、两个 Phase 1B 活动计划文件、Task 05 合同/计划和 Task 05 verifier。Task 05 C1 review、manifest、ZIP 在治理提交后按 C1 规则重新生成；Task 01—04 合同、任务实例、模板、验证器与 Batch A/Batch B 固定证据继续冻结，不属于待改写的当前活动引用。
