...
当前 Phase 1B Task 01—06 Stage B 的活动治理以
...
authority 使用全文件、无自引用 SHA 约定；Task 01—05 已完成并冻结，Task 06 Stage B 已实施并通过内部验证，C1 已生成并等待负责人审阅。
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`：原子范围精确为 V5 authority、`AGENTS.md`、`PLANS.md`、`README.md`、本文件、`docs/project/SCOPE_AND_NON_SCOPE.md`、两个 Phase 1B 活动计划文件、Task 06 合同/计划和 Task 06 verifier。V4 authority、Task 05 C2 acceptance、Task 01—04 合同与冻结证据均保持原样；Task 06 C1 review、manifest、ZIP按本轮证据规则重生成，Task 06 C2仍未授权。
