...
当前 Phase 1B Task 01—06 与 Task 07 Stage A formalization 的活动治理以
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`：原子范围精确为 V6 authority、`AGENTS.md`、`PLANS.md`、`README.md`、本文件、`docs/project/SCOPE_AND_NON_SCOPE.md`、两个 Phase 1B 活动计划文件、Task 06 合同/计划和 Task 06 verifier。V5 及更早 authority、Task 06 C2 acceptance、Task 01—05 合同与冻结证据均保持原样；Task 06 C1 review、manifest、ZIP 保持为 C1 历史冻结快照，不在本轮重生成范围内。
