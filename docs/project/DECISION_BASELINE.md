...
为准（SHA-256：`F2C77C7A1EEE626619CB19DDD994D2D373D59C54CBB939260E7C3B7C77B52D5A`）。authority 使用全文件、无自引用 SHA 约定；
...
minimal entrypoint repair 已获授权，但整体仍为 `BLOCKED_ENTRYPOINT_AND_INTEGRATION_GAP`；C1/C2 尚未授权；Task 18+ 尚未启动且未获授权。
