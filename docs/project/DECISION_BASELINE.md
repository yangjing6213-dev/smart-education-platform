...
当前 Phase 1B Task 01—12 与后续授权状态的活动治理以
`docs/project/PHASE_1B_GOVERNANCE_AND_API_FRAMEWORK_AUTHORITY_V27.md`
为准（SHA-256：`F83FA211CFE14170DA43864FEB46A834EA1430447C47BBF8488E9186509DCBB6`）。
authority 使用全文件、无自引用 SHA 约定；Task 01—12 已接受并冻结；Task 12
post-acceptance minimal route repair 已实现、验证、通过负责人审阅并冻结；Task
13 Stage A 已通过负责人审阅，Stage B 已授权但尚未启动；Task 13 C1/C2 与
Task 14+ 未授权。
