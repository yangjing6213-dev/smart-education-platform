...
当前 Phase 1B 追认 Task 01—04 已完成；Task 05 仅完成 Stage A formalization，尚未启动实现。
活动治理以
...
本次按 `CHANGE_CONTROL.md` §5 采用 `HISTORICAL_FREEZE_PLUS_ACTIVE_REFERENCE_CLOSURE`，活动原子范围精确为 authority、`AGENTS.md`、`PLANS.md`、`README.md`、`docs/project/DECISION_BASELINE.md`、本文件及两个 Phase 1B 活动计划文件。Task 01—03 合同、任务实例、模板、验证器与 Batch A/Batch B 固定证据仍为冻结引用，不在当前改写范围内。
