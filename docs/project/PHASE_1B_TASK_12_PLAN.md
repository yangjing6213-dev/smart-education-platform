...
`b856fd809b2ee00e12907d1fd28a5c6186e6b8a2`, and passed owner review. Under V19,
only Task 12 Stage C1 review, detached manifest, and deterministic ZIP are
authorized now. The dependency order remains `T02 -> T03 -> T05`; Task 02,
Task 03, and Task 05 remain accepted and frozen. Task 10 Stage B, Task 12 C2,
...
V19 C1 execution boundary is separate and exact:
...
The C1 review must explicitly record that `apps/api/src/server.ts` does not
register the Task 12 route module; no global endpoint reachability may be
claimed. C1 creates no acceptance record and does not authorize Task 13+.

## Future evidence lifecycle placeholders

The original lifecycle design is retained here, with its active V19 status:
...
Only the three authorized C1 evidence files are created under V19. No C2
acceptance or Task 13+ implementation is authorized.
...
TASK_12_STAGE_B_STATUS=OWNER_REVIEW_PASSED
TASK_12_STAGE_C1_AUTHORIZATION=GRANTED
TASK_12_STAGE_C1_STATUS=READY_FOR_OWNER_REVIEW
TASK_12_STAGE_C2_AUTHORIZATION=NOT_GRANTED
TASK_12_STAGE_C2_STATUS=NOT_STARTED
TASK_12_STARTED=YES_STAGE_C1_READY_FOR_OWNER_REVIEW
TASK_13_PLUS_STARTED=NO
TASK_13_PLUS_AUTHORIZATION=NOT_GRANTED
OWNER_REVIEW_GATE=TASK12_STAGE_C1_BEFORE_C2
STOP_REASON=TASK12_STAGE_C1_OWNER_REVIEW_GATE_BEFORE_C2
