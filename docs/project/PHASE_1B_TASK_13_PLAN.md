...
After the V27 governance sync and successful verification, the authorized future
executor may explicitly stage the four Stage B paths, inspect the staged diff,
and create the recorded implementation commit. Stage B completion does not
grant C1 or C2. C1 and C2 each require separate authorization and evidence.
