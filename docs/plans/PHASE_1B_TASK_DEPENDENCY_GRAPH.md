...
evidence. Task 05 Stage B is implemented and Stage C1 evidence is waiting at
the project-owner review gate.
...
TASK_05_PRECONDITION=EXPLICIT_OWNER_PASS_FOR_STAGE_C1_BEFORE_STAGE_C2
